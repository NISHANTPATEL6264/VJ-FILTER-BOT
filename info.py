...
API_ID = int(environ.get('API_ID', '22407855'))
API_HASH = environ.get('API_HASH', '297c667830b9f72e15722d76ae74d207')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6392435701').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '--1002035853291').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Koyeb:Koyeb@cluster0.rzkqvfn.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002076740663'))
