...
URL = "https://botnb.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://botnb.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://botnb.onrender.com/".format(FQDN)
else:
    URL = "https://botnb.onrender.com/".format(FQDN)
